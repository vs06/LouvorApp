...
class RehearsalScreen extends StatefulWidget {
  ...
  RehearsalScreen(Rehearsal? r) {
    ...
    if (rehearsal?.data != null) {
      dateController.text =
          DateUtilsCustomized.dataComplentaFormatada(r!.data ?? DateTime.now());
    }

    rehearsalWithoutChanges = rehearsal?.clone();
  }

  RehearsalScreen.modify(
      Rehearsal rehearsalWithChanges, Rehearsal rehearsalWithoutChanges) {
    rehearsal = rehearsalWithChanges != null
        ? rehearsalWithChanges.clone()
        : Rehearsal();
    if (rehearsal?.data != null) {
      dateController.text = DateUtilsCustomized.dataComplentaFormatada(
          rehearsalWithChanges.data!);
    }

    this.rehearsalWithoutChanges =
        rehearsalWithoutChanges != null ? rehearsalWithoutChanges : null;
  }
...
class RehearsalScreenState extends State<RehearsalScreen> {
  ...
  Future _selectDate() async {
    ...
    if (picked != null) {
      setState(() => widget.dateController.text =
          "${picked.toLocal().day}/${picked.toLocal().month}/${picked.toLocal().year.toString().substring(2, 4)}");
  ...
  Future<Null> _selectTime(BuildContext context) async {
    ...
    if (picked != null) {
      ...
      setState(() => widget.rehearsal!.data = new DateTime(
          widget.rehearsal!.data!.year,
          widget.rehearsal!.data!.month,
          widget.rehearsal!.data!.day,
          selectedTime.hour,
          selectedTime.minute));
    }
  }
        ...
        appBar: AppBar(
          title: widget.rehearsal != null
              ...
              : Text(DateFormat('dd/MM/yyyy')
                  .format(widget.rehearsal!.data ?? DateTime.now())),
          centerTitle: true,
        ),
                ...
                children: <Widget>[
                    ...
                    Padding(
                      ...
                      child: Container(
                          ...
                          child: DropdownButton<String>(
                            value: widget.rehearsal!.type == null
                                ? valueRehearsalTypeDropDownSelected
                                : widget.rehearsal?.type,
                            ...
                            items: UserManager.isUserAdmin == true
                                ? AppListPool.rehearsalTypes
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Visibility(
                          visible: widget.rehearsal?.data == null ||
                              widget.rehearsal!.data!.isAfter(DateTime.now()),
                          child: GestureDetector(
                            onTap: () {
                              ...
                              Navigator.of(context).push(MaterialPageRoute(
                                  builder: (context) => SongsServiceScreen
                                      .buildSongsRehearsalScreen(
                                          widget.rehearsal)));
                            },
                            child: Icon(
                              (widget.rehearsal?.lstSongs == null ||
                                      widget.rehearsal?.lstSongs!.length == 0)
                  ...
                  Expanded(
                    ...
                    child: ListView.builder(
                        ...
                        itemCount: widget.rehearsal!.lstSongs == null
                            ? 0
                            : widget.rehearsal!.lstSongs!.length,
                        shrinkWrap: true,
                      ...
                      return Visibility(
                          ...
                          child: ElevatedButton(
                            onPressed: () async {
                              if (widget.formKey.currentState!.validate()) {
                                context
                                    .read<RehearsalManager>()
                                    .update(rehearsal);
                                Navigator.of(context).pop();
                                String predefinedWhatsAppMessage =
                                    getPredifiniedWhatsAppMessage(
                                        widget.rehearsal);
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) =>
                                        LoadingScreen.whatsAppMessage(
                                            predefinedWhatsAppMessage)));
                              }
                            },
